      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{ asset('assets/img/avatarr.png') }}"
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="/blog" class="nav-link"><i data-feather="monitor"></i><span>Blog</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.posts.index') }}" class="menu-toggle nav-link has-dropdown"><i
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="tag"></i><span>Tags</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.tags.index') }}">Tags</a></li>
                <li><a class="nav-link" href="{{ route('admin.tags.create') }}">Create Tags</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="user"></i><span>Users</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.author.index') }}">Users</a></li>
                <li><a class="nav-link" href="{{ route('admin.author.create') }}">Create User</a></li>
              </ul>
            </li>
            @auth
            <li class="dropdown">
              <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
         class="text-gold-300 hover:text-gold-100 underline" class="nav-link"><i data-feather="monitor"></i><span>Logout</span></a>
            </li>
             <form id="logout-form" action="{{ route('logout') }}" method="POST" class="hidden">
        @csrf
            </form>
